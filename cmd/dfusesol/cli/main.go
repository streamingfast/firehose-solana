...
func Main() {
	cobra.OnInitialize(func() {
		allFlags = flags.AutoBind(RootCmd, "DFUSESOL")
	})
...
var startCmdExample = `dfusesol start relayer merger --merger-grpc-serving-addr=localhost:12345 --relayer-merger-addr=localhost:12345`
