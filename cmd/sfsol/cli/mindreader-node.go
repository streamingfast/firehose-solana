...
func init() {
	...
	appLogger, appTracer := logging.PackageLogger("mindreader", fmt.Sprintf("github.com/streamingfast/sf-solana/mindreader"))
	...
	launcher.RegisterApp(zlog, &launcher.AppDef{
		...
		FactoryFunc: nodeFactoryFunc("mindreader-node", "mindreader", appLogger, appTracer, nodeLogger),
	})
