...
function main() {
  ...
  generate "sf/solana/type/v1/account.proto"
  ...
  echo "streamingfast/firehose-solana/proto revision: `GIT_DIR=$ROOT/.git git log -n 1 --pretty=format:%h -- proto`" >> ./last_generate.txt
}
