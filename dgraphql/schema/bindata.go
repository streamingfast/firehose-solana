...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 815, mode: os.FileMode(420), modTime: time.Unix(1608563392, 0)}
...
func serum_fillGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "serum_fill.graphql", size: 1504, mode: os.FileMode(420), modTime: time.Unix(1610381411, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func serum_marketGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "serum_market.graphql", size: 110, mode: os.FileMode(420), modTime: time.Unix(1608563392, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func tokenGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "token.graphql", size: 180, mode: os.FileMode(420), modTime: time.Unix(1608563392, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
