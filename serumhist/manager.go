...
func (m *Manager) getFillsForPrefix(ctx context.Context, prefix keyer.Prefix, limit int) (out []*pbserumhist.Fill, err error) {
	...
	zlog.Debug("found fills ", zap.Int("count", len(out)))
