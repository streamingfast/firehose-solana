...
* added `print-block` subcommand for debugging

## v1.3.0

* added `cost_units` field to `sf.solana.type.v1.TransactionStatusMeta` message.

## v1.2.0

* Updated to last `firehose-core` version.

* Updated Docker to use also `latest` firehose-core image when building.
